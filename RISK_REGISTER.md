...
|----|------|---------|----------|-------------------|
| 1  | Bangla translation unverified | No fluent reader on team | Switch to Twi-in-Latin | Hour 4 — **already resolved** (see `LOCALE_DECISION.md`; locked at scaffold time) |
...
| 8  | Bangla font subsetting fails | Bundle exceeds 200KB | Use system fallback fonts; accept slightly degraded glyph rendering | Not applicable — locale is Twi-in-Latin |
...
- **Risk #1 pre-empted.** Locale decision locked at scaffold time, before any UI work, because the decision shapes font loading, bundle targets, and the messages directory. See `LOCALE_DECISION.md`.
